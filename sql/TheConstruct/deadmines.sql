...
-- Defias Evoker
UPDATE creature_template SET minlevel=61,maxlevel=63,minhealth=14696,maxhealth=16912,armor=3111,mindmg=2400,maxdmg=3400,baseattacktime=1200,rangedattacktime=1200,dmg_multiplier=1 WHERE entry=1729;

-- Defias Strip Miner
UPDATE creature_template SET minlevel=61,maxlevel=62,minhealth=17534,maxhealth=17706,armor=3600,mindmg=3400,maxdmg=4400,baseattacktime=1200,rangedattacktime=1200,dmg_multiplier=1 WHERE entry=4416;

-- Defias Overseer
UPDATE creature_template SET minlevel=62,maxlevel=63,minhealth=19540,maxhealth=19780,armor=3840,mindmg=4400,maxdmg=5400,baseattacktime=1200,rangedattacktime=1200,dmg_multiplier=1 WHERE entry=634;

-- Defias Watchman
UPDATE creature_template SET minlevel=62,maxlevel=63,minhealth=17534,maxhealth=17706,armor=3600,mindmg=3400,maxdmg=4400,baseattacktime=1200,rangedattacktime=1200,dmg_multiplier=1 WHERE entry=1725;

-- Defias Taskmaster
UPDATE creature_template SET minlevel=61,maxlevel=62,minhealth=17534,maxhealth=18706,armor=4600,mindmg=3400,maxdmg=4400,baseattacktime=1200,rangedattacktime=1200,dmg_multiplier=1 WHERE entry=4417;

-- Defias Wizard
UPDATE creature_template SET minlevel=61,maxlevel=62,minhealth=17534,maxhealth=18706,armor=2600,mindmg=2400,maxdmg=3400,baseattacktime=2000,rangedattacktime=2000,dmg_multiplier=1 WHERE entry=4418;
...
-- Goblin Woodcarver
UPDATE creature_template SET minlevel=57,maxlevel=59,minhealth=19700,maxhealth=21000,armor=4514,mindmg=3400,maxdmg=4000,baseattacktime=1000,rangedattacktime=1000,dmg_multiplier=1 WHERE entry=641;

-- Goblin Engineer
UPDATE creature_template SET minlevel=57,maxlevel=59,minhealth=19700,maxhealth=22000,armor=4614,mindmg=3400,maxdmg=4000,baseattacktime=1000,rangedattacktime=1000,dmg_multiplier=1 WHERE entry=622;

-- Goblin Craftsman
UPDATE creature_template SET minlevel=57,maxlevel=59,minhealth=20700,maxhealth=20900,armor=4414,mindmg=3400,maxdmg=4000,baseattacktime=1000,rangedattacktime=1000,dmg_multiplier=1 WHERE entry=1731;

-- Goblin Shipbuilder
UPDATE creature_template SET minlevel=59,maxlevel=60,minhealth=19700,maxhealth=20900,armor=5414,mindmg=3400,maxdmg=4000,baseattacktime=1000,rangedattacktime=1000,dmg_multiplier=1 WHERE entry=3947;

-- Sneed's Shredder
UPDATE creature_template SET minlevel=63,maxlevel=63,minhealth=281977,maxhealth=281977,armor=5100,mindmg=4400,maxdmg=5000,baseattacktime=1500,rangedattacktime=1500,dmg_multiplier=1,MovementType=1,AIName='',ScriptName='boss_sneeds_shredder' WHERE entry=642;
...
-- Gilnid
UPDATE creature_template SET minlevel=63,maxlevel=63,minhealth=292001,maxhealth=292001,armor=4734,mindmg=4400,maxdmg=5400,baseattacktime=1000,rangedattacktime=1000,dmg_multiplier=1,MovementType=1,AIName='',ScriptName='boss_gilnid' WHERE entry=1763;
...
-- Defias blackguard
UPDATE creature_template SET minlevel=58,maxlevel=59,minhealth=29140,maxhealth=29260,armor=4640,mindmg=4400,maxdmg=5000,baseattacktime=1200,rangedattacktime=1200,dmg_multiplier=1 WHERE entry=636;

-- Defias Pirate
UPDATE creature_template SET minlevel=58,maxlevel=59,minhealth=29740,maxhealth=30260,armor=4840,mindmg=4400,maxdmg=5000,baseattacktime=1200,rangedattacktime=1200,dmg_multiplier=1 WHERE entry=657;

-- Defias Squallshaper
UPDATE creature_template SET minlevel=58,maxlevel=59,minhealth=28750,maxhealth=29222,armor=3420,mindmg=4400,maxdmg=5000,baseattacktime=1200,rangedattacktime=1200,dmg_multiplier=1 WHERE entry=1732;
...
-- Cookie
UPDATE creature_template SET minlevel=63,maxlevel=63,minhealth=310345,maxhealth=310345,armor=5533,mindmg=4500,maxdmg=5500,baseattacktime=750,rangedattacktime=750,dmg_multiplier=1,speed_walk=1.4,speed_run=1.84286,MovementType=1,AIName='',ScriptName='boss_cookie' WHERE entry=645;
...
-- Edwin VanCleef
UPDATE creature_template SET minlevel=63,maxlevel=63,minhealth=326594,maxhealth=326594,armor=5533,mindmg=4500,maxdmg=5500,baseattacktime=750,rangedattacktime=750,dmg_multiplier=1,MovementType=1 WHERE entry=639;
